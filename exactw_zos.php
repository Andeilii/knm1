	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["saved_records"] as $keys => $values)
		{
			if($values["saved_id"] == $_GET["data"])
			{
				...
				echo '<script>window.location="exactw_zos.php"</script>';
			}
		}
	}
}
        ...
        if ($result){
          ...
          ' <div class="container">
            ...
            <span><b>'.$row["Pozostalý"].'</b>
             ...
             <br>
             <p1>Rodné priezvisko:</p1><p2> '.$row["Rodné_priezvisko"].'</p2>
             <br>
             <br>
             ...
             <br>
             <br>
             <p1>Povolanie:</p1><p2> '.$row["Povolanie"].'</p2>
             <br>
             <br>
             <p1>Poznámka:</p1><p2> '.$row["Iné_rodina"].'</p2>
             <br>
             <br>
             <p1>Dátum úmrtia:</p1><p2> '.$row["deň_úmrtia"].'. '.$row["mesiac_úmrtia"].' '.$row["Rok_zápisu"].'</p2>
             </div>
             <div class="content-small1">
             <h5>Digitalizát dostupný na portáli Familysearch</h5>

             <a href="https://www.familysearch.org/ark:/61903/3:1:33S7-9RQ4-68C?i=334&wc=9P32-7MD%3A107654301%2C137936301%2C137976901%2C138010601&cc=1554443"><img id="myImg" src="pic/zos_pic.png" class="image"/></a>
             </div>
             <div class="content-large2">
             <h4>Rodina</h4>
             <p1>Pozostalosť po:</p1><p2> '.$row["Pozostalý_po_meno"].' '.$row["Pozostalý_po_druhé_meno"].'</p2>
             <br>
             <br>
             <p1>Matka:</p1><p2> '.$row["Matka"].'</p2>
             <br>
             <br>
             <p1>Matka povolanie:</p1><p2> '.$row["Matka_povolanie"].'</p2>
             <br>
             <br>
             <p1>Otec:</p1><p2> '.$row["Otec"].'</p2>
             <br>
             <br>
             <p1>Otec povolanie:</p1><p2> '.$row["Otec_povolanie"].'</p2>
             <br>
             <br>
             <p1>Manžel/ka:</p1><p2> '.$row["Manžel_ka"].'</p2>
             <br>
             <br>
             <p1>Manžel/ka povolanie:</p1><p2> '.$row["Manžel_ka_povolanie"].'</p2>
             <br>
             <br>
           
             <h4>Ďalšie informácie o zosnulom</h4>
             <p1>Príčina úmrtia:</p1><p2> '.$row["Príčina_úmrtia"].'</p2>
             <br>
             <br><p1>Konfesia:</p1><p2> '.$row["Konfesia"].'</p2>
             
             <br>
             <br><p1>Pomazal:</p1><p2> '.$row["Pomazanie"].'</p2>
             <br>
             <br><p1>Ďalšie infomácie:</p1><p2> '.$row["Iné_zosnulí"].'</p2>
             <br>
			...
			<div class="col-md-4">
				<form method="post" action="exactw_zos.php?data=<?php echo $row["id"]; ?>">
