	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["saved_records"] as $keys => $values)
		{
			if($values["saved_id"] == $_GET["data"])
			{
				...
				echo '<script>window.location="exactw_48.php"</script>';
			}
		}
	}
}
...
text-decoration: underline;
  ...
  <body ontouchstart>
    <nav class="nav">
      ...
      <a href="mainmenu.html" class="nav__link">Hlavné menu</a>
      <div class="nav__link">
          Vyhľadávanie
          <div class="nav__link-group">
            <a href="index.html" class="nav__link">Mapové</a>
        ...
        if ($result){
          ...
          ' <div class="container">
            ...
            <span><b>'.$row["Pozostalý"].'</b>
              '.$row["Meno"].' '.$row["Priezvisko"].' <b>'.$row["Iné_rodina"].'</b></span>
             ...
             <br>
             <br>
             <p1>Číslo domu:</p1><p2> '.$row["Číslo_domu"].'</p2>
             <br>
             <br>
             <p1>Vrstva:</p1><p2> '.$row["Vrstva"].'</p2>
             <br>
             <br>
             <p1>Vlastnosť majetku:</p1><p2> '.$row["Kategória_majetku"].'</p2>

             

             </div>
             <div class="content-small1">
             <h5>Tereziánsky urbár - vlastník danej sesie</h5>
             <a href="'.$row["Urbár_link"].'"><img id="myImg" src="pic/urbár_pic.png" class="image"/></a>
             </div>

             <div class="content-large2">
             <h4>Vlastník podľa urbára:</h4>
             
             <p1>Meno:</p1><p2>'.$row["Pozostalý_urbár"].' '.$row["Meno_urbár"].' '.$row["Priezvisko_urbár"].' '.$row["Dodatočné_info_urbár"].'</p2>
             <br>
             <br>
             <p1>Pripomienky:</p1><p2> '.$row["Pripomienky"].'</p2>
             <br>
             <br>
			...
			<div class="col-md-4">
				<form method="post" action="exactw_48.php?data=<?php echo $row["id"]; ?>">
